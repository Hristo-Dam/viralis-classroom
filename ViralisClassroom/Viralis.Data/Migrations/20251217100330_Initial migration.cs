        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssigningTeacherId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Assignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Assignments_AspNetUsers_AssigningTeacherId",
                        column: x => x.AssigningTeacherId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassroomTeachers_AspNetUsers_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAssignments", x => new { x.AssignmentId, x.StudentId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Submissions_UserAssignments_AssignmentId_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_AssigningTeacherId",
                table: "Assignments",
                column: "AssigningTeacherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAssignments_StudentId",
